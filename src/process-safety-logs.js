...
var ProcessMetroPublicSafetyLogs = function (Directory) {
    return ReadAllDirectoryFiles(Directory, function (FilePath) { return __awaiter(void 0, void 0, void 0, function () {
...
ProcessMetroPublicSafetyLogs('input');
